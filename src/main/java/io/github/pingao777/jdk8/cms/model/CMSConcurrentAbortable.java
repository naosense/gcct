 ...
 */
public class CMSConcurrentAbortable extends ResultData {
    private Date date;
    ...
    public CMSConcurrentAbortable() {
        super(Phrase.CMS_CONCURRENT_ABORTABLE_PRECLEAN);
    }
